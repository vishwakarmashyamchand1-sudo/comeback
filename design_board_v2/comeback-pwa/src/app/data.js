...
export const profile = {
  ...
  since: 'Jun 2026',
  initials: 'P',
  weight: 78.5, height: 175, bmi: 25.6,
  goal: 'Lose fat · 75kg by Sep',
  schedule: '4 days / week · evenings',
  diet: 'Eggetarian · no whey',
  streak: 12,
  level: 'Returning athlete',
};
...
export const dayTypes = [
  ...
  { id: 'core',   name: 'Core & mobility', muscles: 'Abs · flexibility',           icon: 'ti-body-scan' },
];

// Weekly gym + diet summary (Progress tab table)
export const weekSummary = [
  { day: 'Mon', workout: 'Pull',   status: 'done',   protein: 128, kcal: 1980 },
  { day: 'Tue', workout: 'Push',   status: 'today',  protein: 94,  kcal: 1640 },
  { day: 'Wed', workout: 'Rest',   status: 'rest',   protein: 116, kcal: 1910 },
  { day: 'Thu', workout: 'Legs',   status: 'done',   protein: 122, kcal: 2040 },
  { day: 'Fri', workout: 'Push',   status: 'done',   protein: 130, kcal: 1950 },
  { day: 'Sat', workout: 'Missed', status: 'missed', protein: 68,  kcal: 2320 },
  { day: 'Sun', workout: '—',      status: 'none',   protein: null, kcal: null },
];
export const weekAvg = { done: '4 / 5 done', protein: 94, kcal: 1973 };

// Full exercise chart per circle member (member detail sheet)
export const memberWorkouts = {
  rohit: {
    session: 'Pull day', time: 'Today, 6:40 AM', durationMin: 52, sets: 18, prs: 2,
    exercises: [
      { name: 'Deadlift', pr: true, sets: 3, weight: '120kg', reps: '8 · 8 · 6' },
      { name: 'Lat pulldown', sets: 3, weight: '55kg', reps: '12 · 12 · 10' },
      { name: 'Barbell row', sets: 3, weight: '50kg', reps: '10 · 10 · 10' },
      { name: 'Face pull', sets: 3, weight: '25kg', reps: '15 · 15 · 15' },
      { name: 'Barbell curl', pr: true, sets: 3, weight: '30kg', reps: '12 · 10 · 9' },
    ],
  },
};
