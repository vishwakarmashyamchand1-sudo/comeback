...
export default function AppShell() {
  ...
  let tabScreen;
  if (tab === 'workout') tabScreen = <Dashboard done={workoutDone} onStart={() => push('plan')} onViewSummary={() => setStack(['post'])} onOpenCircle={() => push('circle')} goDiet={() => setTab('diet')} onOpenProfile={() => push('profile')} onChangeDay={() => push('plan')} />;
